<template>
  <div>
    ...
    <div class="text-justify pa-10 page-content">
      ...
      <v-row>
        <v-col cols="12" sm="8" md="7">
          <div class="data-base-element">
            <p class="text-h6">(1) Archaeological sites</p>
          ...
          <div class="data-base-element">
            ...
            <p class="text-subtitle-1">2.b. Painting</p>
            <p class="text-subtitle-1">2.c. Coins and medals</p>
            <p class="text-subtitle-1">2.d. Jewelry</p>
      ...
      <v-row>
        <v-col cols="12" sm="6">
          <v-img
            ...
            height="180px"
            src="/csm_2_Mints_Chorasan_bd0a8a687e.jpg"
          />
          <p
            class="text-caption text-left secondary lighten-1 pa-2"
        ...
        <v-col cols="12" sm="6">
          <v-img
            ...
            position="center center"
            height="180px"
            src="/csm_111_Two_Mints_Sandran_807ae93813.jpg"
          />
          <p
            class="text-caption text-left secondary lighten-1 pa-2"
      ...
      <h2
        class="text-h4 mt-15"
      >Categories of Authenticity for Objects in the Shahi Kingdoms Database</h2>
